 ...
 * @author Quichiz
 */
@WebServlet(name = "LogGoogleQuichiz", urlPatterns = {"/LogGoogleQuichiz"})
public class LogGoogleQuichiz extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GoogleIdTokenVerifier verifier = new GoogleIdTokenVerifier.Builder(new NetHttpTransport(), new GsonFactory())
                    .setAudience(Collections.singletonList("57413579502-ojrqgnkogp94dv4q745h7tma834jh2pt.apps.googleusercontent.com"))
                    .build();
